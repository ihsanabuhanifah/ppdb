...
const TesStudi = () => {
  ...
  const questions = [
    ...
    },
    {
      id: 2,
      question:
        "Di Negara Indonesia warganya memiliki agama dan keyakinan yang berbeda-beda. Untuk mengatur kehidupan bersama diperlukan. . .",
      options: [
        "Kekuatan militer untuk memaksa para warga negaranya",
        "Peraturan untuk menekan warga yang tidak mau mengikuti kemauan minoritas",
        "Peraturan bersama dan menempatkan kedudukan yang sama di depan hukum",
        "Kebersamaan dalam menguasai parlemen",
      ],
      answer:
        "Peraturan bersama dan menempatkan kedudukan yang sama di depan hukum",
    },
    {
      id: 3,
      question:
        "Sesungguhnya orang yang paling mulia di sisi Allah swt. dikarenakan. . . . ",
      options: [
        "Tinggi Ilmunya",
        "Banyak Ibadahnya",
        "Banyak Kedermawanannya",
        "Derajat Ketakwaannya",
      ],
      answer: "Derajat Ketakwaannya",
    },
    {
      id: 4,
      question:
        "Meskipun penduduk Indonesia merupakan kaum mayoritas, kita tidak pernah menindas kaum minoritas. Sikap demikian merupakan aplikasi dari ajaran islam, yaitu. . . .",
      options: ["Tabayun", "Tawadhu’", "Toharoh", "Tasammuh"],
      answer: "Tasammuh",
    },
    {
      id: 5,
    ...
    },
    {
      id: 6,
      question:
        "Sebagai pelajar yang beriman, kita wajib memahami konteks kehidupan di dunia ini di mana kita hidup, belajar, dan bekerja. Agar memahami konteks kejadian yang terjadi di dunia, maka kita harus mengenal bahwa taqdir Allah itu dapat dibedakan menjadi. . . .",
      options: ["Dua macam", "Tiga macam", "Empat macam", "Enam macam"],
      answer: "Dua macam",
    },
    {
      id: 7,
    ...
    },
    {
      id: 9,
      question:
        "Manusia itu hanya bisa berusaha, namun penentu dari segala hasil akhir adalah Allah swt. pernyataan tersebut adalah. . . .",
      options: [
        "Benar sesuai ajaran agama",
        "Benar manakala usahanya sesuai dengan yang ditentukan Allah SWT",
        "Benar ketentuan Allah dan tidak dapat diubah keadaanya",
        "Benar hanya ketika ketentuan bersamaan dengan usaha manusia",
      ],
      answer: "Benar manakala usahanya sesuai dengan yang ditentukan Allah SWT",
    },
    {
      id: 10,
      question:
    ...
    },
    {
      id: 11,
      question:
        "Bacalah paragraf berikut dengan seksama! Pukul 11 siang setelah pulang sekolah badan terasa lemas dan perut sakit. Lalu ibu mengungkit kejadian tadi malam dan menashatiku.Tidak tega mealihat aku kesakitan, ibu menyuruhku makan kemudian minum obat, jika benar-benar tidak kuat lagi berpuasa. Berdasarkan isinya, paragraf tersebut termasuk unsur teks eksemplum pada bagian ...",
      options: ["Orientasi", "Insiden", "Interpretasi", "Koda"],
      answer: "Insiden",
    },
    {
      id: 12,
    ...
    },
    {
      id: 13,
      question:
        "Akhirnya, setelah berpamitan aku langsung ke arah parkiran mobilku.Tiba-tiba saat aku hendak masuk ke dalam mobilku, tiba-tiba ada seorang lelaki yang menarik tanganku dan mendekap mulutku. Lalu laki-laki tersebut mengatakan “Berikan uang atau kau mati!”. Kata rujukan dalam kutipan teks di atas adalah ...",
      options: ["Lalu", "Tersebut", "Setelah", "dan"],
      answer: "Tersebut",
    },
    {
      id: 14,
      question:
        "Bacalah ilustrasi peristiwa berikut dengan cermat! Kebelet di Tempat Umum. Daffa ingat betul, ketika pagi tadi berangkatdari rumah, ia melihat sepiring ketoprak kesukaannya tergeletak di meja. Ia langsung menghabiskan makanan tersebut sampai ludes,walaupun rasa pedas sedikit menyiksanya. Sekarang, di halte bus ini,Daffa merasakan perutnya sangat sakit,dan ingin cepat buang air besar. Interpretasi yang kurang tepat terhadap peristiwa tersebut adalah ...",
      options: [
        "Sakit perut yang dialami Daffa, disebabkan sifatrakusnya akan makanan milik orang lain",
        "Kalau saja Daffa tidak menghabiskan ketoprak tersebut,mungkin dia tidak akan sakit perut",
        "Makan makanan dengan rasa pedas saat pagi hari akan memicu sakitperut dan mulas.",
        "Sakit perut dan rasa ingin buang air besar dimungkinkan karena makan makanan pedas",
      ],
      answer:
        "Sakit perut yang dialami Daffa, disebabkan sifatrakusnya akan makanan milik orang lain",
    },
    ...
    },
    {
      id: 20,
      question:
        "Bacalah kalimat berikut ini! 1. Saya tidak sependapat dengan hal-hal yang berkaitan dengan bullying di sekolah. 2. Menteri Dalam Negeri menyatakan bahwa saat ini perekonomian Indonesia sudah stabil. 3. Saya menyetujui apa yang dikatakan oleh Kaploda Banten mengenai larangan merokok. 4. Simpulan itu menunjukkan bahwa pelaku bullying harus ditindak dengan tegas. Berdasarkan kalimat di atas, kalimat yang menyatakan Ungkapan tanggapan dengan sudut pandang orang lain, terdapat pada kalimat nomor...",
      options: ["1", "2", "3", "4"],
      answer: "2",
    },
    {
    ...
    },
    {
      id: 22,
      question:
        "Seorang pengusaha kiranya harus mempunyai bekal dalam menghadapi suatu persaingan yang terjadi dalam perdagangan adalah tingkat harga. Upaya pengusaha untuk menghadapi persaingan harga dengan produsen lain adalah…",
      options: [
        "memberikan bonus untuk pembelian tertentu",
        "mengurangi kualitas produk yang dihasilkan",
        "menurunkan harga jual di bawah harga pesaing",
        "menyebarkan isu negatif terhadap produk pesaing",
      ],
    ...
    },
    {
      id: 25,
      question:
        "Negara Indonesia menjual barang (x) dengan harga di luar negeri lebih murah daripada di dalam negeri. Tujuan negara Indonesia melakukan kebijakan tersebut yaitu agar negara Indonesia dapat menguasai pasar. Kebijakan yang dilakukan Indonesia tersebut dikenal dengan istilah ….",
      options: ["Politik Dumping", "Tarif", "Proteksi", "Kuota"],
      answer: "Kouta",
    },
    {
      id: 26,
      question:
        "Berikut hambatan perdagangan internasional, kecuali adanya ....",
      options: ["Proteksi", "Kouta", "Pulitik Dumping", "Harga lebih mahal"],
      answer: "Harga lebih mahal",
    },
    {
      id: 27,
      question:
        "Berikut tujuan perdagangan bebas pada Masyarakat Ekonomi ASEAN, kecuali …",
      options: [
        "Supaya menarik Foreign Direct Investment lebih banyak lagi",
        "Memiliki perkembangan ekonomi yang merata",
        "Memprioritaskan Usaha Kecil Menengah",
        "Berfungsi sebagai pasar tunggal",
      ],
      answer: "Supaya menarik Foreign Direct Investment lebih banyak lagi",
    },
    {
      id: 28,
      question:
    ...
    },
    {
      id: 30,
      question:
        "Yang dipromosikan oleh kebijakan perdagangan bebas yaitu, kecuali ...",
      options: [
        "Perdagangan barang dan jasa dengan pajak tinggi",
        "Bebas dalam akses pasar",
        "Bebas dalam akses informasi",
        "Tidak ada hambatan dalam perdagangan barang maupun jasa",
      ],
      answer: "Perdagangan barang dan jasa dengan pajak tinggi",
    },
    {
      id: 31,
      question: "This is .... book. .... is there",
      options: ["my – Your", "mine – Yours  ", "my – Yours", "mine – Your"],
      answer: "my – Your",
    },
    {
      id: 32,
      question: "Tiger is a wild animal. ... has sharp claws",
      options: ["He", "She", "Its", "It"],
      answer: "It",
    },
    {
      id: 33,
      question: "Hey Siti, __________ _ _ __ go star gazing tonight",
      options: ["are you", "how about", "shall them", "would you like to"],
      answer: "would you like to",
    },
    {
      id: 34,
      question: "Fadillah is absent yesterdaybecause ....was sick",
    ...
    },
    {
      ...
      options: [
        ...
        "She didn’twant Raden Prabu marry the princess",
        "She wanted Teja Nirmala to forget abouther wedding",
        "She didn’twant the prince of Blambangan marrythe princess",
      ],
      answer: "She didn’twant the prince of Blambangan marrythe princess",
    },
    {
      id: 40,
      question:
        "What do you think will happen if gods or goddesses cannotmingle in the affairs of people in the earth at that time?",
      options: [
        "TWicked Fairy will not take Raden Begawan’s life",
        "Sang Prabu will not hold strength competition",
        "Raden Begawan will notdie",
        "Teja Nirmala will stayin the Kahyangan",
      ],
      answer: "Wicked Fairy will not take Raden Begawan’s life",
    },
    {
      id: 41,
      question:
        "Contoh dari tanaman yang melakukan perkembang biakan melalui tunas adventif yaitu ….",
      options: ["Kamboja", "Ukiran", "Cocor Bebek", "Kaktus"],
      answer: "Cocor Bebek",
    },
    {
      id: 42,
    ...
    },
    {
      id: 45,
      question:
        "Tidak melakukan pergaulan bebas serta tidak mengkonsumsi obat-obatan terlarang adalah usaha untuk mencegah terjadinya penyakit ….",
      options: ["Epidimistis", "Keputihan", "Kudis Kronis", "AIDS"],
      answer: "AIDS",
    },
    {
      id: 46,
      question:
        "Upaya yang dapat dilakukan untuk mencegah tertularnya penyakit menular seksual yaitu dengan …",
      options: [
        "Pernikahan dini",
        "Perilaku seks bebas",
        "Bergonta ganti Pasangan",
        "Menjaga Kesehatan Organ Kelamin",
      ],
      answer: "Menjaga Kesehatan Organ Kelamin",
    },
    {
      id: 47,
      question:
    ...
    },
    {
      id: 48,
      question:
        "Salah satu jenis penyakit pada alat kelamin yang diakibatkan oleh virus yaitu ….",
      options: [
        "Herpes dan AIDS",
        "Sifilis dan Gonore",
        "Gonore dan Herpes",
      ...
      answer: "Gonore dan Herpes",
    },
    {
      id: 49,
      question: "Penyakit kelamin AIDS diakibatkan oleh …",
      options: [
        "Virus HIV",
        "Virus Herpes",
        "Bacteria Neisseria",
