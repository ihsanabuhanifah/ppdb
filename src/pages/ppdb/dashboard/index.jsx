    ...
    <div>
      ...
      <div className="leading-relaxed mt-5 font-semibold">
        <p className="text-justify">
          Pertama kami ucapkan <span className="italic">Syukron Jazakumullah Khairan</span> sudah mendaftar sebagai santri baru di SMK MADINATULQURAN.
        </p>
       ...
       {isPayment === true ? "" : (( <div className="w-full flex justify-center items-center mt-5">
          <button
            onClick={() => {
